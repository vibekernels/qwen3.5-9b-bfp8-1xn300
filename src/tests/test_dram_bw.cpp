...
static std::string kernel_path(const char* name) {
    return std::string("/home/ubuntu/qwen3.5-9b-bfp8-1xn300/src/tests/kernels/") + name;
}
        ...
        for (auto& t : tests) {
            ...
            for (uint32_t block : block_sizes) {
                ...
                auto reader_kid = CreateKernel(program3,
                    "/home/ubuntu/qwen3.5-9b-bfp8-1xn300/src/kernels/dataflow/reader_gemv_dram_sharded.cpp",
                    all_cores3,
                    DataMovementConfig{.processor = DataMovementProcessor::RISCV_1,
                                       .noc = NOC::RISCV_1_default,
                ...
                auto compute_kid = CreateKernel(program3,
                    "/home/ubuntu/qwen3.5-9b-bfp8-1xn300/src/kernels/compute/gemv.cpp",
                    all_cores3,
                    ComputeConfig{.math_fidelity = MathFidelity::HiFi4, .compile_args = compute_ct_args});
                ...
                auto writer_kid = CreateKernel(program3,
                    "/home/ubuntu/qwen3.5-9b-bfp8-1xn300/src/kernels/dataflow/writer_gemv_multicore.cpp",
                    all_cores3,
    ...
    printf("\n=== Test 4: Per-dispatch overhead (trace replay) ===\n");
    {
        ...
        auto build_gemv_program = [&]() -> Program {
            ...
            auto rk = CreateKernel(prog,
                "/home/ubuntu/qwen3.5-9b-bfp8-1xn300/src/kernels/dataflow/reader_gemv_dram_sharded.cpp", ac,
                DataMovementConfig{.processor = DataMovementProcessor::RISCV_1,
                                   .noc = NOC::RISCV_1_default, .compile_args = rca});
            auto ck = CreateKernel(prog,
                "/home/ubuntu/qwen3.5-9b-bfp8-1xn300/src/kernels/compute/gemv.cpp", ac,
            ...
            auto wk = CreateKernel(prog,
                "/home/ubuntu/qwen3.5-9b-bfp8-1xn300/src/kernels/dataflow/writer_gemv_multicore.cpp", ac,
                DataMovementConfig{.processor = DataMovementProcessor::RISCV_0,
